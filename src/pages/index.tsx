...
export default function Home() {
  ...
  // 返回页面布局
  return (
    <Layout title={tagline} description={description}> {/* 设置页面标题和描述 */}
      <main> {/* 主内容区域 */}
        <Hero /> {/* 渲染英雄部分 */}
        <Particles className="absolute inset-0" quantity={100} ease={80} color={'#ffffff'} refresh /> {/* 渲染粒子效果 */}

        <div className="relative"> {/* 相对定位的容器 */}
          <div className="mx-auto max-w-7xl bg-background lg:px-8"> {/* 设置最大宽度和背景 */}
            <BlogSection /> {/* 渲染博客部分 */}
